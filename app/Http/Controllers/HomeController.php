...
class HomeController extends Controller
{
    ...
    public function sessao(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($nivel == 'Despachador' & $unidade == 'Radio-patrulhamento') {
                $trabalhando = $unidade . '-' . $bpmm;
            }

            if ($nivel == 'Despachador' & $unidade == 'Especialidades') {
                $trabalhando = $unidade . '-' . $especialidade;
            }

            if ($nivel == 'Despachador' & $unidade == 'Bombeiros') {
            ...
            if ($nivel == 'Administrador_master') {
                $trabalhando = 'Administrador_master';
            }
