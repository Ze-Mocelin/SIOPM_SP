...
class BpmmController extends Controller
{
    ...
    public function batalhoes()
    {
        return view('batalhoes');
    }
    /**
    ...
    public function create(Request $request)
    {
        if ($request->isMethod('post'))
        {
            ...
            $messages = [
                ...
                'poligono.required' => 'Campo obrigatório',
            ];
            ...
            if ($validator->fails()){
                ...
                $b -> descricao = e($request->descricao);
                $b -> poligono = e($request->poligono);
