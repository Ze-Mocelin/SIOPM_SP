                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="inputCidade" class="form-control" id="inputCidade"
                                            list="cidades-list" placeholder="Digite a cidade"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="inputEndereco" class="form-control" id="inputEndereco"
                                            placeholder="Endereço" value="{{ $ocorrencia['endereco'] }}" required>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="inputNumero" class="form-control" id="inputNumero"
                                            placeholder="Número" value="{{ $ocorrencia['numero'] }}" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                            data-select2-id="1" tabindex="-1" aria-hidden="true" name="inputSelectAdress"
                                            id="inputSelectAdress" value="{{ $ocorrencia['bairro'] }}"
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="inputBatalhao" class="form-control"
                                            id="inputBatalhao" placeholder="Batalhão" value="{{ $ocorrencia['bpmm'] }}"
                                            required>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="inputCompanhia" class="form-control"
                                            id="inputCompanhia" placeholder="Cia" value="{{ $ocorrencia['cia'] }}"
                                            required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="inputNaturezaocorrencia" class="form-control"
                                            ...
                                            value="{{ $ocorrencia['naturezaocorrencia'] }}" onchange="getPerguntas(this)"
                                            required>
                ...
                <div class="card card-danger card-outline">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <div class="p-1">
                                                ...
                                                <label style="font-size: 15px; font-weight: bold;" class="display-5"
                                                    id="displayQuestion"></label>
                                                <p style="font-size: 12px;" class=" lead" id="displayDescription"></p>
                                            </div>
                                            <div class="form-floating">
                                                <label for="floatingTextarea" class="form-label">Resposta do
                                                    solicitante</label>
                                                ...
                                                <div id="dispatcherAck"
                                                    class="bg-danger text-white font-weight-bold text-center"
                                                    style="display: none;">
                                                    <i class="fa-solid fa-bolt fa-fade"></i> DESPACHADOR DO BATALÃO CIENTE <i class="fa-solid fa-bolt fa-fade"></i>
                                                </div>
                            ...
                            <div class="row p-2">
                                <div class="col-md-3">
                                    <button type="button" class="btn btn-block btn-outline-warning btn-sm text-center"
                                        id="btnAlertaParcial">ALERTA PARCIAL</button>
                                </div>
                                <div class="col-md-3">
                                    <button type="button" class="btn btn-block btn-outline-danger btn-sm text-center"
                                        id="btnAlertaGeral">ALERTA GERAL</button>
                                </div>
                                <div class="col-md-3">
                                    <button type="button"
                                        class="btn btn-block bg-gradient-warning btn-sm text-center">GERAR SOP</button>
                                </div>
                                <div class="col-md-3">
                                    <button type="button"
