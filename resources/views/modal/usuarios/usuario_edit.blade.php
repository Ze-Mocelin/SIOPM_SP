                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" name="nivel" id="nivel">
                                    ...
                                    <option value="STQ" @if($u->nivel=='STQ')selected @endif>STQ</option>
                                    <option value="Tecnica" @if($u->nivel=='Tecnica')selected @endif>Técnica</option>
                                    <option value="Certidoes" @if($u->nivel=='Certidoes')selected @endif>Certidões</option>
                                    <option value="Chefia" @if($u->nivel=='Chefia')selected @endif>Chefia</option>
                                    <option value="Administrador_master" @if($u->nivel=='Administrador_master')selected @endif>Administrador master</option>
                               </select>
                            </div>
                        </div>
                        <div class="col-md-4">
