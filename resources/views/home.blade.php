...
<body>
  ...
  <div id="container">
    <div id="inviteContainer">
      <div class="logoContainer">
        <img class="logo" src="{{ url('img/copom.png') }}" />
      </div>
                    ...
                    <select id="nivel" name="nivel">
                        ...
                        @switch(Auth::user()->nivel)
                            ...
                            @case('Administrador_master')
                                ...
                                <option value="Tecnica">Técnica</option>
                                <option value="Chefia">Chefia</option>
                                <option value="Administrador_master">Administrador master</option>
                            @break
                            @default
                        @endswitch
                    </select>
  ...
  <script>
    ...
    nivel.addEventListener("change", function() {
      ...
      } else if (this.value === "Despachador") {
