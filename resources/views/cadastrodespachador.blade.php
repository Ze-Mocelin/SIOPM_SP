                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column">
                            ...
                            <a class="btn btn-app bg-secondary" data-toggle="modal" data-target="#modal-ramaisprincipais">
            ...
            <div class="col-md-11">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-center">
                            <form method="POST" autocomplete="off" class="col-md-8" action="{{url('cadastro190/create')}}">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-md-8 mb-3">
                                        <label for="inputSolicitante" class="form-label">Solicitante</label>
                                        <div class="d-flex align-items-center">
                                            <input type="text" name="inputSolicitante" id="inputSolicitante" class="form-control" autocomplete="off" placeholder="Digite o nome do solicitante" value="{{old('inputSolicitante')}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="inputReferencia" class="form-control" id="inputReferencia" placeholder="Digite uma referência">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        ...
                                        <input type="text" name="inputCompanhia" class="form-control" id="inputCompanhia" placeholder="Companhia" required>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group">
                                            ...
                                            <datalist id="naturezaocorrencia-list">
                                                ...
                                                <option value="{{$n->codigo}}">{{$n->codigo}} - {{$n->descricao}}</option>
                                                @endforeach
                                            </datalist>
                                    ...
                                    <div class="row">
                                        <div class="row col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="historico" class="form-control" id="historico" placeholder="Histórico Inicial" rows="3" cols="180"></textarea>
                                            </div>
                                        </div>   
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer justify-content-between">
                                    <button type="reset" class="btn btn-outline-light" data-dismiss="modal">Limpar</button>
...
// Use o valor do input hidden como necessário
console.log(valorInputHiddenplaca,valorInputHiddenchassis,valorInputHiddenmarcav,valorInputHiddenmodelov,valorInputHiddencor,valorInputHiddensituacaov);
...
<script>
    ...
    function fetchBPMM(lat, lon) {
        ...
        if (hostname === "localhost") {
            url = "http://localhost/siopm-off2/public/api/battalion-map";
