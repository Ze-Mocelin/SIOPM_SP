...
@section('content_header')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Informações cadastro de ocorrências</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Informações cadastro de ocorrências</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
@section('content')
    ...
    $cadastro_ocorrencia = App\Models\Publication::where('type', 2)
